...
- **Preparação:** workshops pré-viagem (contexto geopolítico · etiqueta · pagamentos · conduta cultural)

Detalhe financeiro em `docs/financeiro/modelo-comercial.md`.

## Dependências críticas

- **Parceiro local único** · agência China é single point of failure (tradução · logística · reservas)
- **Registro Canton Fair** · gratuito mas obrigatório · fazer com antecedência
- **Credenciais visitas técnicas** · Alibaba · DJI · 4Paradigm precisam agendamento
- **Pagamentos in-country** · orientar grupo (cash · app local · VPN pra apps chineses)
- **Vistos** · China é obrigatório · alertar cadeiras com 60 dias de antecedência
...
| Nota NPS pós-viagem | ≥ 70 | survey pós-viagem |

## Arquivos deste diretório

- `README.md` · este documento (visão da missão)
- `cadeiras-missao.md` · 4 tipos de cadeira + pricing + audiência-alvo
- `agenda-dia-a-dia.md` · roteiro operacional detalhado 15 dias

## Next steps

- [ ] **P0** · Travar datas exatas em torno Canton Fair · @matheus + @thiago · 2026-08-15
- [ ] **P0** · Contrato formal com agência local China · @matheus · 2026-08-30
- [ ] **P0** · Abrir vendas das 8-12 cadeiras · @felipe + @matheus · 2026-09-01
- [ ] **P1** · Reservar credenciais Canton Fair · Alibaba · DJI · 4Paradigm · @thiago · 2026-09-15
- [ ] **P1** · Estruturar 4 workshops preparação pré-viagem · @felipe · 2026-09-30
- [ ] **P2** · Reconciliar roteiro com cidades do movimento institucional (Shenzhen · Hangzhou) · @matheus + @thiago · 2026-08-30

## Related

- `roteiro.md` (raiz) · roteiro operacional visão condensada (versão Thiago original)
- `docs/viagem-jan-fev-2026/README.md` · viagem anterior de reconhecimento
- `docs/financeiro/modelo-comercial.md` · detalhe ticket + margens
- `docs/players/` · empresas-alvo de visita técnica
- `docs/contexto/movimento-brasil-china.md` · camada institucional paralela

## Changelog

**v1.0 · 2026-07-15** · Documento criado consolidando a visão do produto de imersão INTEL7 China. Origem: `README.md` + `roteiro.md` (repo raiz · commits Thiago 2026-07-15) + `~/projects/brasil-china-abrasel/index.html` (agenda dia-a-dia).
